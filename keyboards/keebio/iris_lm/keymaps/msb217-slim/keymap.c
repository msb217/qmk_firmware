...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
            ...
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PENT, KC_P4, KC_P5, KC_P6, KC_PCMM, KC_NO,
            KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P0, KC_P1, KC_P2, KC_P3, KC_PEQL, KC_NO,
