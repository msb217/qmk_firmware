...
tap_dance_action_t tap_dance_actions[] = {
    [TD_F1_F11] = ACTION_TAP_DANCE_DOUBLE(KC_1, KC_11),
    [TD_F2_F12] = ACTION_TAP_DANCE_DOUBLE(KC_2, KC_12),
    [TD_F3_F13] = ACTION_TAP_DANCE_DOUBLE(KC_3, KC_13),
    [TD_F4_F14] = ACTION_TAP_DANCE_DOUBLE(KC_4, KC_14),
    [TD_F5_F15] = ACTION_TAP_DANCE_DOUBLE(KC_5, KC_15),
    [TD_F6_F16] = ACTION_TAP_DANCE_DOUBLE(KC_6, KC_16),
    [TD_F7_F17] = ACTION_TAP_DANCE_DOUBLE(KC_7, KC_17),
    [TD_F8_F18] = ACTION_TAP_DANCE_DOUBLE(KC_8, KC_18),
    [TD_F9_F19] = ACTION_TAP_DANCE_DOUBLE(KC_9, KC_19),
    [TD_F10_F20] = ACTION_TAP_DANCE_DOUBLE(KC_10, KC_20)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT(
            KC_NO, KC_P1, KC_P2, KC_P3, KC_P4, KC_P5, KC_P6, KC_P7, KC_P8, KC_P9, KC_P0, KC_NO,
            KC_NO, TD_F1_F11, TD_F2_F12, TD_F3_F13, TD_F4_F14, TD_F5_F15, TD_F6_F16, TD_F7_F17, TD_F8_F18, TD_F9_F19, TD_F10_F20, KC_NO,
